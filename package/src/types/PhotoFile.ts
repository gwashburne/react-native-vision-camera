...
export interface TakePhotoOptions {
  ...
  path?: string
  /**
   * A custom file name that will be applied to the photo.
   *
   * Do not include the file extension; VisionCamera will apply that.
   *
   * By default, Vision Camera will generate a UUID
   */
  name?: string
  /**
